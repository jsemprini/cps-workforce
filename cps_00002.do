...
quietly infix                   ///
  ...
  int     metarea      57-60    ///
  long    county       61-65    ///
  byte    statecensus  66-67    ///
  byte    cbsasz       68-69    ///
  long    metfips      70-74    ///
  byte    individcc    75-75    ///
  int     faminc       76-78    ///
  byte    pernum       79-80    ///
  double  wtfinl       81-94    ///
  double  cpsidp       95-108   ///
  double  asecwt       109-119  ///
  int     relate       120-123  ///
  byte    age          124-125  ///
  byte    sex          126-126  ///
  int     race         127-129  ///
  byte    marst        130-130  ///
  byte    popstat      131-131  ///
  byte    vetstat      132-132  ///
  int     hispan       133-135  ///
  byte    empstat      136-137  ///
  byte    labforce     138-138  ///
  int     occ          139-142  ///
  int     ind          143-146  ///
  int     uhrsworkt    147-149  ///
  int     uhrswork1    150-152  ///
  byte    covidunaw    153-154  ///
  byte    covidlook    155-156  ///
  using `"cps_00002.dat"'
